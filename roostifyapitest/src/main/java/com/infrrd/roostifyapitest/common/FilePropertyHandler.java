package com.infrrd.roostifyapitest.common;
...
public class FilePropertyHandler
{
    ...
    {
        InputStream inputStream = FilePropertyHandler.class.getClassLoader().getResourceAsStream( propFile + ".properties" );
